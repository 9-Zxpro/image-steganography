...
public class ImageSteganography extends BaseSteganography {
     ...
     */
    public ImageSteganography(File input, byte pixelsPerByte) throws IOException, UnsupportedImageTypeException{
    ...
    public byte[] getHeader() throws CannotDecodeException{
        ...
        if (revealByte(0,0,(byte)1) != (byte) 'M' && revealByte(0,0,(byte)1) != (byte) 'I')
